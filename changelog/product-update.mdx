...
To Learn more about how to manage entitlements in Meteroid, read our [dedicated documentation](https://docs.meteroid.com/)
...
We have added a **Docker Compose setup for local development**, making it easier to run Meteroid end-to-end on your machine without complex setup steps.
