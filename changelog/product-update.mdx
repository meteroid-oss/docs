...
Invoices can now be issued in the customer's or invoicing entity's preferred language:
* Set an invoicing language per Customer or Invoicing Entity
* Invoice footers are translated accordingly

<Frame>
<img
  src="/public/meteroid-invoice-language.png" 
  alt="Multi-language invoicing settings in Meteroid"
/>
</Frame>

## Enhanced Invoice Corrections

You can now add or edit rows in invoice annexes directly within a correction, giving you full control over the breakdown Customers see when an invoice is corrected.

## New Payment Payments

We shipped a new payment provider architecture that makes it much easier to contribute and integrate new payment providers. Thanks to community contributor **ibougihub**, who built the new Stancer integration on top of it. We added as well the GoCardless integration.

<Frame>
<img
  src="/public/meteroid-payment-providers.png" 
  alt="Payment provider integrations in Meteroid, including the new Stancer plugin"
/>
</Frame>

## Automatic Refresh of Draft Invoices

Draft invoices are now automatically refreshed in the background on an hourly basis, so they stay up to date even before finalization.

## Self-hosting: Helm Chart

We've published an official Helm chart for deploying Meteroid open source, making it easier to run Meteroid on Kubernetes.

</Update>

<Update label="July 2026" description="v1.0.0">

## Meteroid Intelligence

We released Meteroid Intelligence that turns the billing and usage data you already have into a full analytics suite, computed from the same subscriptions, invoices, payments and events that drive your billing. 

**27 built-in metrics**

MRR, ARR, NRR, churn, cash, retention, revenue mix — plus your own usage metrics — in one explorer you can break down, filter, compare and forecast.

**Steering**

Put a monitor on any metric and get alerted on thresholds, % changes, anomalies, usage limits, even forecast breaches.

**Customer Signals**

A live roster of who's slipping and who's expanding, with the MRR at stake, wired straight to the account — for your sales & CS teams.

**Dashboards**

Live data, refreshed hourly. Configure and add your charts and KPIs, then share your dashboards externally with your team or stakeholders.

<Frame>
<img
  src="/public/meteroid-intelligence-dashboard.png" 
  alt="Meteroid Intelligence dashboard with ARR, billed revenue and usage charts"
/>
</Frame>

## Security

We've extended our Security module with two new capabilities:

**Roles & Permissions (RBAC)**

Define granular roles and permissions to control what each team member can access and do in Meteroid.

<Frame>
<img
  src="/public/meteroid-rbac-permissions.png" 
  alt="Roles and permissions management in Meteroid"
/>
</Frame>

**Single Sign-On (SSO)**

Your team can now sign in through your organization's OIDC identity provider — Okta, Microsoft Entra ID, Google Workspace, Auth0, or any OIDC-compliant provider. Admins verify their email domains, connect the provider, and can optionally require SSO and auto-provision members on first sign-in.

💡 More information on SSO in Meteroid [here](https://docs.meteroid.com/settings/single-sign-on)

<Frame>
<img
  src="/public/meteroid-sso.png" 
  alt="Single Sign-On configuration in Meteroid"
/>
</Frame>

## Billable Metrics Filters & Live Usage Preview

**Filter events** — Only count what matters. Include or exclude events by their properties — region, status, anything on the event — so a metric measures exactly what you mean.

**Preview & explore usage** — Once your events are ingested, explore them directly in Meteroid and split usage by customer, before it ever reaches an invoice.

<Frame>
<img
  src="/public/meteroid-billable-metric-preview.png" 
  alt="Registering a billable metric with live usage preview in Meteroid"
/>
</Frame>

## Custom Properties in CSV Imports

Customer and subscription CSV imports now support custom properties, so you can bring your own metadata along when importing data into Meteroid.

</Update>

<Update label="June 2026" description="v1.0.0">

## Enhanced Customer Portal

The Customer Portal can now be customized to match your brand and for an even deeper level of integration, the Customer Portal can now be embedded directly inside your own application using our UI components, so Customers never have to leave your product at all. 

💡 More information on Meteroid's Customer Portal customization [here](https://docs.meteroid.com/customer/customer-portal#portal-customization)

<Frame>
<img
  src="/public/meteroid-portal-custom.png" 
  alt="Customizing Meteroid's Customer Portal"
/>
</Frame>

## Multi-factor Authentication (MFA) 

You can now enable Multi-Factor Authentication on your Meteroid account for an extra layer of login security.

💡 More information on MFA in Meteroid [here](https://docs.meteroid.com/settings/two-factor-authentication)

<Frame>
<img
  src="/public/meteroid-mfa.png" 
  alt="multi-factor Authentication in Meteroid"
/>
</Frame>

## Floor Price

You can now define a **minimum invoiced amount** on a Plan, regardless of the calculated charges: 
* the floor price can be applied to the Plan or to specific Products within a Plan
* it can be overridden per Subscription, to set customer-specific minimum commitments without touching the Plan itself

💡 More information on floor prices in Meteroid [here](https://docs.meteroid.com/billing/creating-products-and-modeling-your-pricing#floor-price)

<Frame>
<img
  src="/public/meteroid-floor-prices.png" 
  alt="Floor prices in Meteroid"
/>
</Frame>

## Invoice consolidation

Meteroid can now merge invoices from a Customer's different subscription into one single consolidated invoice simplifying both your end your Customers' accounting. 

💡 More information on invoice consolidation in Meteroid [here](https://docs.meteroid.com/settings/invoices-settings#consolidating-recurring-invoices)

<Frame>
<img
  src="/public/meteroid-invoice-consolidation.png" 
  alt="Invoice consolidation in Meteroid"
/>
</Frame>

## Appendices

You can now attach detailed appendices to your invoices, for example, a full breakdown of the usage events behind a usage-based charge. This gives Customers full visibility into what they're being billed for, directly alongside the invoice.

💡 More information on Invoice Appendices in Meteroid [here](https://docs.meteroid.com/billing/managing-invoice-annexes)

<Frame>
<img
  src="/public/meteroid-appendices.png" 
  alt="Invoice Appendices in Meteroid"
/>
</Frame>
...
<Frame>
<img
  src="/public/meteroid-entitlements.png" 
  alt="Entitlements in Meteroid"
/>
</Frame>
...
<Frame>
<img
  src="/public/metroid-amend-susbscriptions.png" 
  alt="Updating existing subscriptions in Meteroid"
/>
</Frame>
...
<Frame>
<img
  src="/public/meteroid-quote-simulation.png" 
  alt="Quote usage simualtion"
/>
</Frame>
...
<Frame>
<img
  src="/public/meteroid-activity-section.png" 
  alt="Activity section at Subscription level"
/>
</Frame>
...
<Frame>
<img
  src="/public/meteroid-audit-log.png" 
  alt="Audit log in Meteroid"
/>
</Frame>
