...
We have formalized the workflow for changing customer plans (whether it is upgrading or downgrading) to improve lifecycle management and support [Product-Led Growth](/meteroid/glossary/saas-plg) (PLG) strategies. Plan upgrades and downgrades can be managed in two ways:
