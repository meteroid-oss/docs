...
A Subscription can be created either: 

* manually by Account Managers directly in Meteroid
* automatically on CheckOut
* automatically via API (cf. API Reference) 
* via a csv file upload 

## Creating a subscription direclty in Meteroid
...
## Creating a subscription using Meteroid's APIs

To create a subscription via API, please refer to the [API documentation](https://docs.meteroid.com/api-reference/subscriptions/create-subscription).  

## Creating a subscription via a csv file upload

To upload Subscriptions in bulk via CSV:

1. Go to **Subscriptions > Import CSV**.
