...
* Intra-EU B2C supplies take the customer's country rate.
...
The tax rows themselves are labelled in the document's language too — a German invoice shows *USt.*, a Swiss one *MWST* — rather than the engine's internal English label.
